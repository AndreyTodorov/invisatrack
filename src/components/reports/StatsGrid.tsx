...
export default function StatsGrid({ stats }: Props) {
  ...
  const items = [
    ...
    },
    {
      ...
      value: String(totalRemovals),
      color: "var(--text)",
    },
    {
      label: "Avg / Day",
      value: String(Math.round(avgRemovals)),
      color: "var(--text)",
    },
    {
      label: "Longest Off",
      value: formatDuration(longestRemoval),
    ...
    },
    {
      ...
      value:
        stats.length > 0
          ? formatDuration(Math.round(totalOffMinutes / stats.length))
          : "—",
      color: "var(--text-muted)",
    },
    {
