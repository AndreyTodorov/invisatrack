...
export const sessionRef = (uid: string, id: string) =>
  ref(db, `users/${uid}/sessions/${id}`);
export const setsRef = (uid: string) => ref(db, `users/${uid}/sets`);
export const setRef = (uid: string, id: string) =>
  ref(db, `users/${uid}/sets/${id}`);
export const seedVersionRef = (uid: string) =>
  ref(db, `users/${uid}/seedVersion`);
